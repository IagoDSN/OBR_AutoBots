...
in_1 = 17  # forwards left
in_2 = 27  # backwards left
en_a = 18  # speed left

# Motor B (lado direito)
in_3 = 22  # forwards right
in_4 = 23  # backwards right
en_b = 19  # speed right

servo_control_pin = 7
servo_pin_1 = 8
# ATENÇÃO: Mudado de 23 para 5 para liberar o GPIO 23 para o motor
servo_pin_2 = 5 
servo_pin_3 = 24
...
# gpio setup
    # Remapeado para direcionar corretamente os sinais do Motor A (Esquerdo) e Motor B (Direito)
    forward_right = LED(in_3)
    backward_right = LED(in_4)
    forward_left = LED(in_1)
    backward_left = LED(in_2)
    speed_right = PWMLED(en_b, frequency=1000)
    speed_left = PWMLED(en_a, frequency=1000)
    light = LED(led)
